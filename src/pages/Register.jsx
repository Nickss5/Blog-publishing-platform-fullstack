...
const Register = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-between px-6 md:px-[200px] py-4">
        ...
        <div className="w-full flex justify-center items-center h-[60vh] md:h-[80vh]">
            <div className="flex flex-col justify-center items-center space-y-4 w-[80%] md:w-[35%]">
                <h1 className="text-2xl font-serif text-left md:mb-4">Join NClouds.</h1>
                <h1 className="text-xl font-bold text-left mt-2 md:mb-4">Create an account</h1>
                <input  onChange = {(e)=> setUsername(e.target.value)} className="w-[280px] px-4 py-2 border-2 border-black outline-0" type = "text" placeholder = "Enter your UserName" />
                ...
                <button onClick = {handleRegister} className = "w-[280px] px-4 py-2 text-lg font-bold text-white bg-black rounded-lg hover:bg-gray-500 hover:text-black">Register</button>
                {error && <h3 className="text-red-500 text-sm">Something went wrong</h3>}
                <div className = "flex justify-center items-center space-x-4 w-[280px]">
                    <p>Already have an account?</p>
                    <p className="text-green-500 font-bold hover:text-black"><Link to = "/login">Sign in</Link></p>
                </div>
            </div>
        </div>
